...
class DoubleDoubleVector(object):
    ...
    def iterator(self):
        return _example.DoubleDoubleVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _example.DoubleDoubleVector___nonzero__(self)

    def __bool__(self):
        return _example.DoubleDoubleVector___bool__(self)

    def __len__(self):
        return _example.DoubleDoubleVector___len__(self)

    def __getslice__(self, i, j):
        return _example.DoubleDoubleVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _example.DoubleDoubleVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _example.DoubleDoubleVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _example.DoubleDoubleVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _example.DoubleDoubleVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _example.DoubleDoubleVector___setitem__(self, *args)

    def pop(self):
        return _example.DoubleDoubleVector_pop(self)

    def append(self, x):
        return _example.DoubleDoubleVector_append(self, x)

    def empty(self):
        return _example.DoubleDoubleVector_empty(self)

    def size(self):
        return _example.DoubleDoubleVector_size(self)

    def swap(self, v):
        return _example.DoubleDoubleVector_swap(self, v)

    def begin(self):
        return _example.DoubleDoubleVector_begin(self)

    def end(self):
        return _example.DoubleDoubleVector_end(self)

    def rbegin(self):
        return _example.DoubleDoubleVector_rbegin(self)

    def rend(self):
        return _example.DoubleDoubleVector_rend(self)

    def clear(self):
        return _example.DoubleDoubleVector_clear(self)

    def get_allocator(self):
        return _example.DoubleDoubleVector_get_allocator(self)

    def pop_back(self):
        return _example.DoubleDoubleVector_pop_back(self)

    def erase(self, *args):
        return _example.DoubleDoubleVector_erase(self, *args)

    def __init__(self, *args):
        _example.DoubleDoubleVector_swiginit(self, _example.new_DoubleDoubleVector(*args))

    def push_back(self, x):
        return _example.DoubleDoubleVector_push_back(self, x)

    def front(self):
        return _example.DoubleDoubleVector_front(self)

    def back(self):
        return _example.DoubleDoubleVector_back(self)

    def assign(self, n, x):
        return _example.DoubleDoubleVector_assign(self, n, x)

    def resize(self, *args):
        return _example.DoubleDoubleVector_resize(self, *args)

    def insert(self, *args):
        return _example.DoubleDoubleVector_insert(self, *args)

    def reserve(self, n):
        return _example.DoubleDoubleVector_reserve(self, n)

    def capacity(self):
        return _example.DoubleDoubleVector_capacity(self)
    __swig_destroy__ = _example.delete_DoubleDoubleVector

# Register DoubleDoubleVector in _example:
_example.DoubleDoubleVector_swigregister(DoubleDoubleVector)


def square(v):
    return _example.square(v)

def addOne(x):
    return _example.addOne(x)
